...
<html>
    ...
    <body>
        ...
        <input type="hidden" id="EventName" Name="EventName" value="<%=strEvnName%>">
         <input type="hidden" id="strGroupSeq" Name="GroupSeq_S" value="<%=strGroupSeq%>"></td>
        </tr>
         </table>
        <table width="100%" cellspacing="0px" cellpadding="3px" border="0px">
        <tr><td>
                <div id="Mare1" >
                    <jsp:include page="frmShortRegistration_Off_J4.jsp" flush="true" >
...
<br>
 ...
 <table width="30%" align="right">
    ...
    <input class="button" type="button" name="Search" value="Save" onClick="SRSubmit()">
     <input class="button" type="button" name="Search" value="Reset" onClick="SRReset_RAZA(EventSeq,EventName)">
      <input class="button" type="button" name="Search" value="Close" onClick="JQueryClose_Short()">
      <input type="hidden" name="PageID" value="SPECIAL_EVENTS_RAZA"/>
    </td>
