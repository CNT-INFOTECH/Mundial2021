...
<script>
  ...
  function RefreshResults(objValue)
  {
		  ...
		  document.forms[0].action="ListRider.jsp"
...
<table align="center" class="tPasoHead" >
	   <thead>
       <th><font size="3" >View Points Professional Riders/ Vea Puntos por Montador</font></th>
       </thead> 
...
<table class="tPaso">
  ...
  <td <% if (strCategory.equals("Pasofino")) {%> bgcolor="#dce9f9" <%}%>>
           <input type="radio" value='Pasofino' name="chkCategory" onClick="RefreshResults(this.value)" <% if (strCategory.equals("Pasofino")) {%> checked <%}%>>Classic Pasofino</td>
...
<table class="tPaso">
      <thead>
<th data-class="expand" >RIDER NAME</th>
...
catch(Exception Ex)
{
  ...
  <input type="hidden" name="expType" value='5' >
