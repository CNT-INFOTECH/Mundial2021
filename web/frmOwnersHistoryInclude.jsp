...
<%
        ...
        String age_Months="";
        String age_Days="";
//This mode=2  is for regsearchpopup_include for the search icon in the header of the screen near name                                      
       /* String strMode="";
    ...
    {                               
            ...
            RowSetFactory factory17 = RowSetProvider.newFactory();
   CachedRowSet crsGetHorseDetails= factory17.createCachedRowSet();
	    ...
	    if(crsGetHorseDetails.getString("HORSE_COLOR_VAL")!=null)                  
            ...
            System.err.println("++frmOwnershistoryinclude.jsp+++"+e);
        }  
%>
