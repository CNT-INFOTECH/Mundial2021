...
<html>
    ...
    function Selected(SelValue,SelDescValue)
    {
		...
		if(parent.opener.document.forms[0].name=="frmObservationPopup")
		{

			parent.opener.document.forms[0].ShowName.value=SelDescValue;

				self.close();
		}
		else if(parent.opener.document.forms[0].name=="Person_Search")
		{
			parent.opener.document.forms[0].ShowName.value=SelDescValue;
			self.close();
		}
		else if(parent.opener.document.forms[0].name=="PersonObservationPopup")
		{
			parent.opener.document.forms[0].ShowName.value=SelDescValue;
			self.close();
		}
...
/*
     ...
     function ShowList(fieldName,DescElemen)
     {
        ...
        document.forms[0].action="frmShows_Search_Common1.jsp?mode=1&SN="+showName+"&PL="+place+"&Dt="+Date+'&selval='+fieldName+'&DescEl='+DescElemen
...
<table  width="100%">
    <tr>
        <td>
              <%@ include file="frmShows_Search_Common_Include1.jsp"%>
        </td>
    </tr>
