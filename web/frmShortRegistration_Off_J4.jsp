...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <td colspan="11" class="Grid_Header">STALLION 1&nbsp;&nbsp;&nbsp;<% if (!strSht_GroupSeq.equals("0")){%>
  ...
  <tr>
    ...
    <td width="17%" colspan="2">
      ...
      <input type="text"  style="background-color:  #FFF8DC; border:  1px solid #000000;"
               name="RegNum_S" id="RegNum_S" size="10" onChange="CheckRegNumExists4(RegNum_S,'<%=strEventSeq%>','Mare1')"
               value="<%=strSht_RegNum%>">
    <img alt="" src="Images/Find.gif" onClick="SearchHorse('PopHrs',600,600,'yes','1','4','<%=strEventSeq%>')"/>
    </td>
  ...
  <tr>
    ...
    <td width="5%"><font class="dateStyleBody">MONTHS</font></td>
        ...
        <div id="Descendent1" >
           ...
           <td colspan="9">
               <input type="hidden" name="RegSeq_D1" id="RegSeq_D1"  value="<%=strSht_RegSeq_Off%>">
                ...
                <img alt="" src="Images/Find.gif" onClick="SearchHorse_OffSprings('PopHrs',700,550,'yes','1','D1','<%=strEventSeq%>',RegSeq_S.value,'S')"/>
                <a href="#" onClick="OpenLink('PopRegNum',600,550,'yes','frmHrsRegistration.jsp',RegSeq_D1.value,'RegNum','Num=1')" >
        ...
        <div id="Descendent2" >
           ...
           <td colspan="9">
               <input type="hidden" name="RegSeq_D2" id="RegSeq_D2"   value="<%=strSht_RegSeq_Off_2%>">
                ...
                <img alt="" src="Images/Find.gif" onClick="SearchHorse_OffSprings('PopHrs',600,550,'yes','1','D2','<%=strEventSeq%>',RegSeq_S.value,'S')"/>
                <a href="#" onClick="OpenLink('PopRegNum',600,550,'yes','frmHrsRegistration.jsp',RegSeq_D2.value,'RegNum','Num=1')" >
          ...
          <tr><td>
      <div id="Descendent3" >
            <td width="96"><font class="label">DESCENDENT3</font></td>
           <td colspan="9">
               <input type="hidden" name="RegSeq_D3" id="RegSeq_D3"   value="<%=strSht_RegSeq_Off_3%>">

                <input type="text"  style="background-color:  #FFF8DC; border:  1px solid #000000;"
                                    name="RegNum_D3" id="RegNum_D3" size="10"
                                    onblur="GetHorseName_ByNum_off(this.value, 'RegSeq_D3','RegNum_D3','Name_Label_D3')"
                                      value="<%=strSht_RegNum_Off_3%>">
                <img alt="" src="Images/Find.gif" onClick="SearchHorse_OffSprings('PopHrs',600,550,'yes','1','D3','<%=strEventSeq%>',RegSeq_S.value,'S')"/>
                <a href="#" onClick="OpenLink('PopRegNum',600,550,'yes','frmHrsRegistration.jsp',RegSeq_D3.value,'RegNum','Num=1')" >
                <span id="Name_Label_D3" style="color :blue; font-size:12px"  class="Onlycaps"><%=strSht_HorseName_Off_3%></span></a>
          ...
          <tr><td>
       <div id="Descendent4" >
            <td width="96"><font class="label">DESCENDENT4</font></td>
           <td colspan="9">
               <input type="hidden" name="RegSeq_D4" id="RegSeq_D4"   value="<%=strSht_RegSeq_Off_4%>">

                <input type="text"  style="background-color:  #FFF8DC; border:  1px solid #000000;"
                                    name="RegNum_D4" id="RegNum_D4" size="10"
                                    onblur="GetHorseName_ByNum_off(this.value, 'RegSeq_D4','RegNum_D4','Name_Label_D4')"
                                      value="<%=strSht_RegNum_Off_4%>">
                <img alt="" src="Images/Find.gif" onClick="SearchHorse_OffSprings('PopHrs',600,550,'yes','1','D4','<%=strEventSeq%>',RegSeq_S.value,'S')"/>
                <a href="#" onClick="OpenLink('PopRegNum',600,550,'yes','frmHrsRegistration.jsp',RegSeq_D4.value,'RegNum','Num=1')" >
                <span id="Name_Label_D4" style="color :blue; font-size:12px"  class="Onlycaps"><%=strSht_HorseName_Off_4%></span></a>
