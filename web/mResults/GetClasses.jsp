...
<%
    ...
    try {
        ...
        if(dbAction.equalsIgnoreCase("get")){
            cst=conn.prepareCall("{call WS_GET_EVENT_INFORMATION(?,?,?,?)}");
            cst.setString(1, strShowIdent);//ShowName,place,Date,@ShowSeq,@WorkOrderSeq
			cst.setString(2, "");
			cst.setString(3, "");
			cst.setString(4, "");
        }
        ...
        while (rs.next()) {
            ...
            obj.put("Event_Sub_Order", rs.getString("Event_Order"));//Event_Sub_Order
