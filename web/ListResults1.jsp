...
<th  data-class="expand" width="10%">PLC</th>
        ...
        {%>
			...
			<td class="contact" valign="center"><%=rs1.getString("AssignedNum") %></td>
			...
			<td class="contact" valign="center"><%=rs1.getString("Placement") %>
