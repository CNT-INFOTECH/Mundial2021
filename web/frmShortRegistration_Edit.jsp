 ...
 <%@ include file="frmShortRegistration_Include.jsp"%>
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="2">
    ...
    <tr>
      ...
      <td nowrap colspan="6" >
       ...
       <td width="96"><font class="label">EVENT&nbsp;ASSIGNED#</font></td>
        <td width="96"><input type="text"  class="allcaps"
    ...
    <tr>
      ...
      <font color="blue"><span id="place_Lbl" name="place_Lbl"><%=strSht_POB%></span></font></td>
    </tr>
    <tr>
      ...
      <td width="43" colspan="2">
        ...
        <font color="blue"><span id="Sreg_HAGE_Lbl" name="Sreg_HAGE_Lbl"><%=strSht_Age%></span></font>
        </td>
      ...
      <td width="60">
          <font color="blue"><span id="Color_Lbl" name="Color_Lbl"><%=strSht_HORSE_COLOR_VAL%></span></font>
        <input type="hidden"   class="allcaps"
    ...
    <tr>
      ...
      <td colspan="5">
          <img alt="" src="Images/dropdown_icon4.gif"
           ...
           <font color="blue"><span id="AssoNum_Lbl" name="AssoNum_Lbl"><%=strORGNAME%></span></font></td>
      <td>
        <input type="hidden"  class="allcaps"
    ...
    <tr>
      ...
      <td colspan="9">
        ...
        <input type="text"  class="allcaps" name="sireName" id="sireName" size="80"
                    value="<%=strSht_SireName%>" onChange="chkforSire(sire,sireName,'800','500','yes')">
    ...
    <tr>
      ...
      <td colspan="9">
        ...
        <input type="text"  class="allcaps" name="damName" id="damName" size="80"
            value="<%=strSht_DamName%>" onChange="chkforDam(dam,damName,'800','500','yes')">
        <img src="Images/Find.gif" onClick="SearchSireDame('PopPed',600,600,'yes','3','1')">
      </td>
    </tr>
    <tr>
      ...
      <td colspan="9">
        ...
        <input type="text" name="Owner_Assigned"  size="10" class="allcaps"  id="Owner_Assigned"
          ...
          <span id="owner_Label" style="color :blue;"><%=strSht_OwnerFName%> <%=strSht_OwnerMName%> <%=strSht_OwnerLName%></span>
    ...
    <td colspan="9">
      <input type="hidden" name="BreederSeq" size="10" id="BreederSeq"
       ...
       <span id="Breeder_Label" style="color :blue;"><%=strSht_BreederFName%> <%=strSht_BreederMName%> <%=strSht_BreederLName%></span>
      ...
      <td colspan="9">
        <input type="hidden" name="RiderSeq" size="10" id="RiderSeq"
          ...
          <input type="text" name="Rider_Assigned" size="10" class="allcaps" id="Rider_Assigned"
                    value="<%=strSht_RiderSeq_AssignedNum%>" onBlur="GetPersonByAssignedNum(this.value,'RiderSeq','Rider_Assigned','Rider_Label')">


         <img alt="" src="Images/Find.gif" onClick="SearchOwner('Owner',600,550,'yes','3','1')">
          <span id="Rider_Label" style="color :blue;"><%=strSht_RiderFName%> <%=strSht_RiderMName%> <%=strSht_RiderLName%></span>
    ...
    <!-- <input class="button" type="button" name="Search" value="Reset" onClick="SRReset(EventSeq,EventName)">-->
      <input class="button" type="button" name="Search" value="Close" onClick="JQueryClose_Short_Edit()">
      <input type="hidden" name="PageID" value="SREGISTRAION_EDIT"/>
