...
<table align="center" >
       <td ><span ><font><h3><%if (strCountryDesc!=null && strCountryDesc.length()>0 &&  !strCountryDesc.equalsIgnoreCase("NONE")) {%><img src="img/<%=strCountryDesc%>.jpeg"  width='35%'><%}%>&nbsp;<font color="blue"> <%=strCountryDesc %> </font>  </h3></font></span></td>
...
<th  data-class="expand" width="5%">MEDAL</th>
<th  data-class="expand" width="5%">POINTS</th>
 ...
 <%
	    ...
	    while (rs1.next())
        {
			String strPlacement=rs1.getString("Placement");
			if(rs1.getString("Placement").equals("C") ||  rs1.getString("Placement").equals("1") || rs1.getString("Placement").equals("2")){
				
				TotalbyCountry=TotalbyCountry+1;
				TotalPoints+=Integer.parseInt(rs1.getString("Points"));
				%>
				 ...
				 <td class="contact"><%=rs1.getString("Name") %> </td>
				   ...
				   <td class="contact">
					<% 
						if(strPlacement.equals("C"))
							out.println("Gold") ;
						else if(strPlacement.equals("1"))
							out.println("Silver") ;
						else if(strPlacement.equals("2"))
							out.println("Bronze") ;
					%>
					</td>
    ...
    %>
	<tr>
	<td colspan=4 style="text-align:center"> <font size="5" >TOTAL MEDALS</font></td>
	<td  colspan=2> <font size="5" ><%=TotalbyCountry%></font></td>
	</tr>
	<tr>
	<td colspan=4 style="text-align:center"> <font size="5" >TOTAL POINTS</font></td>
	<td  colspan=2 style="text-align:center"> <font size="5" >&nbsp;&nbsp;&nbsp;<%=TotalPoints%></font></td>
	</tr>
	</table>
	</div>
