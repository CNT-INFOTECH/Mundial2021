<%-- 
    Document   : frmModalityAddPopup
    Created on : May 3, 2011, 2:44:25 PM
    Author     : Erzath
--%>
...
<%@ page import="pasotracker.GeneralServlet" %>  
    <body>
        <form name="ModalityAddPopup" method="post">
<%
    String SeqNo="";
    String strValue="";
        ...
        <div id="wrapper1">
            <table width="100%" border="0" class="altRow">
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" maxlength="20" name="txtModality_add" value="<%=strValue%>" id="txtModality_add" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
                        <button id="AddModalityBtn">Add</button>
                    </td>
                </tr>
            </table>
            <input type="hidden" name="HdnModalitySeq" id="HdnModalitySeq" value="<%=SeqNo%>">
        </div>
        </form>           
    </body>
</html>
