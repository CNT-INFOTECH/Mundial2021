...
<script>
  ...
  function RefreshResults(objValue)
  {
		  ...
		  document.forms[0].action="ListBreeder.jsp"
...
<table align="center" class="tPasoHead" >
	   <thead>
       <th><font size="3" >View Points Breeder/ Vea Puntos por Criador</font></th>
       </thead> 
...
<table class="tPaso">
      <thead>
<th data-class="expand" >BREEDER NAME</th>
...
catch(Exception Ex)
{
  ...
  <input type="hidden" name="expType" value='3' >
