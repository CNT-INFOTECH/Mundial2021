...
<script language="javascript">
  ...
  $(function() {
    ...
    function formatResult_O(row) {
        ...
        $("#hor_name").autocomplete("frmAutoSireDamNameList.jsp?ExpType=2", {
		width: 500,
		matchContains: true,
  ...
  function showAlert()
{    
        if(document.forms[0].ViewAll_Dam.checked==true)
        {  
            document.forms[0].HdnViewAll_Dam.value='Y';	
            document.forms[0].DamSearchbtn.click();
        }
}
...
<body >
  <form name="frmDamSearchPopup" method="post" >
...
<div id="framecontent">
<div class="innertube">
        <table width="100%" border="0"  title="SEARCH">
            <tr class="altRow">
                ...
                <td colspan="7">
                    ...
                    padding-left: 18px;text-transform: uppercase;">
                     <input type="button" id="DamSearchbtn" class="button" value="Search"/>

                    <input type="button" id="DamSearchResetbtn" class="button" value="Reset"/>

                    <input type="button" id="DamSearchSelectbtn" class="button" value="OK"/>
                </td>
            </tr>
            ...
            <tr class="altRow">
                ...
                <td width="7%">
                    <input type="text" size="9" name="dob" id="dob" placeholder="mm/dd/yyyy" value="<%=strHor_DOB%>" 
            ...
            <tr class="altRow">
                ...
                <td COLSPAN="5">
                    <input type="text" size="55" name="owner" id="owner"  value="<%=strmem_name%>" style=" background:  #FFF8DC url(Images/magnifier.png) no-repeat 1px 1px; border: 1px solid #000000;
            height: 16px;
            padding-left: 18px;text-transform: uppercase;">
                </td>
...
if(strMode.equals("1"))
{
 ...
 RowSetFactory factory94 = RowSetProvider.newFactory();
   CachedRowSet crsGetHorseDetails= factory96.createCachedRowSet();
           // CachedRowSetImpl crsGetHorseDetails = new CachedRowSetImpl();

            crsGetHorseDetails = gen.GET_DAM(REGSEQ,str_Reg_no,strHor_PName.replace("\'","''"),strHor_DOB,strmem_name,strmicro_num,strRegistration_Type,AssignedNum);
 ...
 <display:table  id="Details" name="requestScope.HorseList"
                        class="grid"
                        style="text-transform:uppercase;border-color:Black;border-width:0px;border-style:None;width:100%;border-collapse:collapse;">
        ...
        <div id="maincontent">
            ...
            <display:table  id="Details" name="requestScope.HorseList"
                ...
                <display:setProperty name="paging.banner.some_items_found">
                    ...
                    <span ><input type="checkbox" name="ViewAll_Dam" id="ViewAll_Dam" onClick="showAlert()"> 
...
<input type="hidden" name="HdnViewAll_Dam" id="HdnViewAll_Dam" value='N' />
