...
padding: 4px;" >&nbsp;General&raquo;&nbsp;&nbsp;&nbsp; </div>
            </td>
          </tr>
          <tr>
            <td>
              <div onclick="Ajax_CheckMember('<%=strASSIGNEDNUM%>','Link','<%=strEntitySeq%>')"  style=" cursor: pointer; background-color: #4e738f; color: #FFFFFF; font-weight: bold;
...
{
%>
onclick="location.href='Person_MemberPin.jsp?Mode=1&Enty=<%=strEntitySeq%>';"  
<%}
else
{
%>
