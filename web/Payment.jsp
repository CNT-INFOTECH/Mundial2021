...
function sendPaymentDataToAnet() {
    ...
    authData.clientKey = "5m33UTFR6T8MZ78Ytz88G8WAuH9Ctp77Bsyfzjmy5s7TN4kDeXMpqpM3R5hV8btn";
    authData.apiLoginID = "6LwCP9v5Rk";
	...
	function processTransaction(responseData) {
		...
		alert(responseData.dataDescriptor)
    /*
...
<body>
	<form>
    Card Number<br>
    <input type="text" id="cardNumberID" placeholder="5424000000000015" autocomplete="off" value="5424000000000015"/><br><br>
    ...
    <input type="text" id="cardCodeID" placeholder="123" value="123" /><br><br>
    Amount<br>
    <input type="text" id="amount" placeholder="10.00"  value="10.00" /><br><br>
