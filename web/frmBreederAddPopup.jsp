...
<%@ page import="pasotracker.GeneralServlet" %>  
    <body>
        <form name="BreederAddPopup" method="post">
<%
    String SeqNo="";
    String strValue="";
 ...
 RowSetFactory factory25 = RowSetProvider.newFactory();
   CachedRowSet crs= factory25.createCachedRowSet();
        ...
        <div id="wrapper1">
            <table width="100%" border="0" class="altRow">
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" maxlength="20" name="txtBreeder_add" value="<%=strValue%>" id="txtBreeder_add" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
                        <button id="AddBreederBtn">Add</button>
                    </td>
                </tr>
            </table>
            <input type="hidden" name="HdnBreederSeq" id="HdnBreederSeq" value="<%=SeqNo%>">
        </div>
        </form>           
    </body>
</html>
