...
<script>
  ...
  function RefreshResults(objValue)
  {
		  ...
		  document.forms[0].action="ListAO.jsp"
...
<table align="center" class="tPasoHead" >
	   <thead>
       <th><font size="3" >View Points AO/ Vea Puntos por DUEÑOS MONTADOS</font></th>
       </thead> 
...
<table class="tPaso">
      <thead>
<th data-class="expand" >AO RIDER NAME</th>
...
catch(Exception Ex)
{
  ...
  <input type="hidden" name="expType" value='6' >
