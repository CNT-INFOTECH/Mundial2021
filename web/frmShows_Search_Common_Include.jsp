...
%>
   ...
   <display:table  id="test" name="sessionScope.test" pagesize="10" 
    ...
    <display:column style="width:1%" headerClass="Grid_Header" >
        <input type="radio" Name="ChkRadio" onClick="Selected(${test.Seq},'${test.Show}');"></display:column>

    <display:column  property="Show"  sortable="true" headerClass="Grid_Header" style="width:25%" />
