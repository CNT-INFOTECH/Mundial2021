...
<table class="altRow" width="100%">
  <tr>
    ...
    <td width="60"  >
      <input type="text"  style="background-color:  #FFF8DC; border:  1px solid #000000;" name="fromDate" size="10" value="<%=strDate%>"
...
<table  width="100%">
    <tr>
        <td>
              <%@ include file="frmEvent_Search_Common_Include.jsp"%>
        </td>
    </tr>
