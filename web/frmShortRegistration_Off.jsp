...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <td colspan="11" class="Grid_Header">MARE 1</td>
  </tr>
  <tr>
    ...
    <td width="17%" colspan="2">
      ...
      <input type="text"  style="background-color:  #FFF8DC; border:  1px solid #000000;"
               name="RegNum_S" id="RegNum_S" size="10" onChange="CheckRegNumExists2(RegNum_S,'<%=strEventSeq%>','Mare1')"
               value="<%=strSht_RegNum%>">
    <img alt="" src="Images/Find.gif" onClick="SearchHorse('PopHrs',600,600,'yes','1','1','<%=strEventSeq%>')"/>
    </td>
  ...
  <tr>
      ...
      <input type="hidden" name="RegSeq_S_Off" id="RegSeq_S_Off"  value="<%=strSht_RegSeq_Off%>">
    </td>
    <td colspan="7">
      <input type="text"  style="background-color:  #FFF8DC; border:  1px solid #000000;"
               name="RegNum_S_Off" id="RegNum_S_Off" size="10"
               onblur="GetHorseName_ByNum_off(this.value, 'RegSeq_S_Off','RegNum_S_Off','Name_Label_off')"
               value="<%=strSht_RegNum_Off%>" >
      <img alt="" src="Images/Find.gif" onClick="SearchHorse('PopHrs',600,600,'yes','1','11','')"/>
      <a href="#" onClick="OpenLink('PopRegNum',600,600,'yes','frmHrsRegistration.jsp',RegSeq_S_Off.value,'RegNum','Num=1')" >
      <span id="Name_Label_off" style="color :blue; font-size:12px"  class="Onlycaps"><%=strSht_HorseName_Off%></span></a>
      <input type="hidden"  name="HorseName_S_Off" size="40" class="allcaps"
        value="<%=strSht_HorseName_Off%>">
    </td>
  </tr>
</table>
<br>
