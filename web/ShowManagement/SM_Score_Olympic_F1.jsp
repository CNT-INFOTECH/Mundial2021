...
<html>
    <head>
        ...
        <title>FIVE JUDGES SCORING SYSTEM</title>
        ...
        <script>
            function ProcessResults()
            {
                ...
                document.forms[0].action = "../Scoring_Results?PAGEID=F1";
            ...
            function Delete_F1_Results() {

            var r = confirm("This will delete the Processed F1 Results");
            if (r == true) {
             var varhdnEventSeq = document.forms[0].hdnEventSeq.value
                document.forms[0].method = "post";
                document.forms[0].action = "SM_Score_Olympic_F1_Clear.jsp?EIdent=" + varhdnEventSeq+"&mode=F1";
                document.forms[0].submit();
    ...
    <body>
        <form>
            ...
            <%@ include file="SM_Score_Olympic_F1_Include.jsp"%>
            <%  
             ArrayList AlAssigned_Num = new ArrayList();
             String strErrorCode="-1";
             if(request.getParameter("ECde")!=null){
                 strErrorCode=request.getParameter("ECde");
                 
                 if(strErrorCode.equals("0"))
                     strErrorCode="Deleted Successfully";
                 if(strErrorCode.equals("1"))
                     strErrorCode="F2 Results Already Processed";
                 if(strErrorCode.equals("2"))
                     strErrorCode="Issue Processing the request";
             }
            ...
            <table>
                <tr>
                    <td align="left" valign="middle" colspan='4'>
                        <input type='checkbox' name='backValidReq' checked>validate back#
                       
                    </td>
                    <td align="left" valign="middle" colspan='8'>
                        <font><b><% if(!strErrorCode.equals("-1")) { out.println(strErrorCode); } %></b></font>
                    </td>
                </tr>
            ...
            <table><tr><td><input type="submit" value="Process F1" onClick='ProcessResults()'> </td>
                    ...
                    <td><input type="button" value="Remove F1 Results" onClick="Delete_F1_Results()"> </td>
                </tr></table>  
