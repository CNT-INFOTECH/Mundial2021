...
<table class="Events" align="center"  border="0" cellpadding="0" cellspacing="0" width="100%" >
        <tr align="center">
          <th>Name</th>
           <th>Number</th>
          <th>J1</th>
...
<%
       ...
       if(strEventSeq_F1_F2.trim().length() >0 )
      {
        ...
        while (rs1.next())
        {
           ...
           <td width="200" align="center"><%=rs1.getString("Horse_PrimaryName")%> <br><font color="blue"><%=rs1.getString("RiderName")%></font></td>
          <td width="10"  align="center"><font size="3"><b> <%=rs1.getString("AssignedNum")%></b></font></td>
