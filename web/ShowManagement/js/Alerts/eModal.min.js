(function(n) {
    n(["jquery"], function(n) {
        ...
        function it(t) {
            ...
            if (t === !1)
                return r;
            if (e = n(h).addClass("modal-footer").prop("id", ft), t)
        ...
        function ct(t, r) {
            ...
            var s = f();
            return e({async: !0, buttons: [{close: !0, click: h, text: u[t.label] ? u[t.label] : u[i.confirmLabel], style: k}, {close: !0, click: h, text: u[t.label] ? t.label : i.confirmLabel}], deferred: s, message: t.message || t, onHide: h, size: t.size, title: t.title || r})
        }
        function lt(t, r) {
            function h() {
            ...
            return e({async: !0, buttons: t.buttons || !1, deferred: u, message: s, size: t.size || nt.xl, title: t.title || r})
        }
        function at() {
            return n("#" + s + " > *").remove()
        }
        function vt(s, h) {
            ...
            if (typeof s == "object" ? n.extend(l, s) : (l.message = s, l.title = h), l.async = !0, l.buttons)
                for (v = 0, p = l.buttons.length; v < p; v++)
                    a = l.buttons[v], a.style = (a.style || "default") + " pull-left", a.type = a.type || "button";
            return w = it([{close: !0, type: "reset", text: u.OK, style: k}, {close: !1, type: c, text: i.confirmLabel}].concat(l.buttons || [])), l.buttons = !1, l.onHide = d, l.message = n('<form role=form style="margin-bottom:0;"><div class=modal-body><label for=prompt-input class=control-label>' + (l.message || r) + '<\/label><input type=text class=form-control required autocomplete="on" value="' + (l.value || r) + (l.pattern ? '" pattern="' + l.pattern : r) + '"><\/div><\/form>').append(w).on(c, d), e(l)
        }
        function yt(t) {
            return n.extend(i, t)
        }
        ...
        var t, s = "recycle-bin", h = "<div>", r = "", w = "click", l = "hide", a = "shown.bs.modal", c = "submit", ft = "eFooter", v = l + ".bs.modal", b = "input", k = "danger", u = {OK: "Cancel", True: "False", Yes: "No"}, d = {}, y = "modal-body", g = {}, p = "modal-rec", nt = {sm: "sm", lg: "lg", xl: "xl"}, tt = "modal-tmp", i = {allowContentRecycle: !0, confirmLabel: "OK", size: r, loadingHtml: '<h5>Loading...<\/h5><div class=progress><div class="progress-bar progress-bar-striped active" style="width: 100%"><\/div><\/div>', title: "Attention"};
        return{ajax: ht, alert: e, close: o, confirm: ct, emptyBin: at, iframe: lt, prompt: vt, setEModalOptions: yt, setModalOptions: pt, size: nt, version: "1.2.05"}
    })
