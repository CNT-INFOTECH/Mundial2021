...
<html>
    <head>
        ...
        <script src="SM_NC_1D.js" type="text/javascript"></script>
    ...
    <body>
        <form>
            ...
            <%@ include file="SM_F2_NC_1D_Include.jsp"%>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type='hidden' id='Judge<%=(i + 1)%>' value='<%=strJudgeAllValues%>'> </td>
                     ...
                     <% if(i==1) {%><td><input type="button" value="Process F2" onClick='ProcessF2Results()'> </td> <%}%>
                     <% if(i==2) {%><td><input type="button" value="Reset" onClick='ResetF2Results("SM_F2_NC_1D.jsp")'> &nbsp;<input type="button" value="Save" onClick='SaveF2Results()'> 
