...
<html>
        ...
        <script>
            function ProcessResults()
            {
                document.forms[0].method = "post";
                 document.forms[0].action = "../../../NC1D?PAGEID=F2_PROCESS_ADNTL_WO";
            ...
            function ResetResults() {
                ...
                document.forms[0].method = "post";
                document.forms[0].action = "SM_AddWork_NC_1D.jsp?R&7a8225d145bb1136c894b1f5dbcd7a8225d145bb1136c894b1f5dbcd&EIdent=" + varhdnEventSeq;
                document.forms[0].submit();
            }
            function WorkOffComplete(){
            
                document.forms[0].method = "post";
                 document.forms[0].action = "../../../NC1D?PAGEID=F2_PROCESS_ADNTL_WO_CMPL"
                document.forms[0].submit();
            }
            ...
            function LoadWorkOff(){
                ...
                document.forms[0].method = "post";
                document.forms[0].action = "SM_AddWork_NC_1D.jsp?7a8225d145bb1136c894b1f5dbcd7a8225d145bb1136c894b1f5dbcd&SIdent="+varhdnShowSeq+"&EIdent=" + varhdnEventSeq+"&Swoc="+varIdentWO;
                document.forms[0].submit();
            }
        </script>
    </head>
    ...
    <body>
        <form>
            ...
            <%@ include file="SM_AddWork_NC_1D_Include.jsp"%>
