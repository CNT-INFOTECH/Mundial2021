<%-- 
    Document   : SM_F2_MOS
    Created on : Jun 6, 2017, 10:37:17 PM
    Author     : CNT
--%>
...
<html>
    <head>
        ...
        <title>PasoKey - 1 Decision Non Conferring</title>
        <link rel="stylesheet" href="../../menu.css" type="text/css" media="screen" />
        <link href="../../Styles/menu.css" rel="stylesheet" type="text/css" />
        <script src="SM_NC_1D.js?111" type="text/javascript"></script>
    ...
    <body>
        <form>
            ...
            <%@ include file="SM_F2_MOS_Include.jsp"%>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type='hidden' size="1" name="<%=strhdnJudgeSeq%>" value="<%=JudgeSeq[i]%>"> <%=JudgeNames[i]%>
                        <input type='hidden' size="1" name="<%=strhdnJudgeNum%>" value="<%=JudgeNum[i]%>"> </td>
                        <%
                    ...
                    <td><input type='hidden' id='Judge<%=(i + 1)%>' value='<%=strJudgeAllValues%>'> </td>
                     <% if(i==0) {%><td><input type="checkbox"  onclick="toggleAutoRefresh(this);" id="reloadCB" checked >Auto Refresh</td> <%}%>
                     <% if(i==1) {%><td><input type="button" value="Process F2" onClick='ProcessF2Results_MOS()'> </td> <%}%>
                     <% if(i==2) {%><td><input type="button" value="Reset" onClick='ResetF2Results("SM_F2_MOS.jsp")'> &nbsp;<input type="button" value="Save" onClick='SaveF2Results()'> 
                     &nbsp;<input type="button" value="Refresh" onClick="location.reload();"> </td><%}%>
         ...
         ************************************************************************************************************************* -->
            ...
            <table id="table_Wo">
                ...
                <tr>
                    ...
                    <% if (i== (AlActualValues_TieBreaker_Mobile_Value.size()-1)){%>
                     <td><input type="button" value="Process Tie Break" onClick='Process_TieBreaker()'> </td>
                     <%}%>
                </tr>       
                <%}%>
            ...
            <table class="Events">
                <tr> <td colspan="8"><font color="blue" size="4">Tie Breaker Results</font></td></tr>
                <th>BACK#</th>
                <th><%=JudgeNames[0]%></th>
                <th><%=JudgeNames[1]%></th>
                <th><%=JudgeNames[2]%></th>
                ...
                <tr>
                    ...
                    <%
                        ...
                        for (int j = 0; j < AlRowJudge.size(); j++) {
                            String strJudgeVal_Tie = "";
                            if (AlRowJudge.get(j) != null && AlRowJudge.get(j).equals("6")) {
                                strJudgeVal_Tie = "X";
                            } else {
                                strJudgeVal_Tie = "" + AlRowJudge.get(j);
                            }
