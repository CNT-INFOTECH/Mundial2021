 ...
 <form>
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="2">
    ...
    <tr>
      ...
      <td width="129"><font class="label">GENDER</font> </td>
    ...
    <tr>
      ...
      <td width="88">
        <input type="text"  class="allcaps"
               ...
               value="<%=strSht_DOB%>"
               onChange="getAge_Months(Sreg_HDOB.value,'Sreg_HAGE_Lbl','')">
        
       <font color="blue"><span id="Sreg_HAGE_Lbl" class="Onlycaps"><%=strSht_Age%></span></font></td>
    ...
    <tr>
      ...
      <span id="Name_Label" style="color :blue; font-size:12px"  class="Onlycaps"><%=strSht_SireName%></span></a>
      </td>
    </tr>
    <tr>
      ...
      <span id="Dam_Label" style="color :blue; font-size:12px"  class="Onlycaps"><%=strSht_DamName%></span></a>
      </td>
    </tr>
    <tr>
    ...
    <input class="button" type="button" name="Search" value="Save" onClick="SR_Hrs_Submit()">
     <input class="button" type="button" name="Search" value="Reset" onClick="SR_Hrs_Reset()">
      <input class="button" type="button" name="Search" value="Close" onClick="SR_Hrs_Close()">
      <input type="hidden" name="PageID" value="HREGISTRAION"/>
    </td>
