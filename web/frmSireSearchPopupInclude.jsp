...
<%
 ...
 RowSetFactory factory23 = RowSetProvider.newFactory();
   CachedRowSet crsGetHorseDetails= factory23.createCachedRowSet();
           // CachedRowSetImpl crsGetHorseDetails = new CachedRowSetImpl();

            crsGetHorseDetails = gen.GET_SIRE(REGSEQ,str_Reg_no,strHor_PName,strHor_DOB,strmem_name,strmicro_num);
