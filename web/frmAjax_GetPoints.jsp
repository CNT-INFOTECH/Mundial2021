...
<%@ page import = "java.util.*" %>
 <%
          ...
          if(strAwardType.equals("1") || strAwardType.equals("2") || strAwardType.equals("3") || strAwardType.equals("4") )
            strHeaderValue="BREEDER";
          else if(strAwardType.equals("5"))
            strHeaderValue="OWNER";
           else if(strAwardType.equals("6") || strAwardType.equals("38") || strAwardType.equals("39"))
            strHeaderValue="RIDER";
          else
            strHeaderValue="HORSE";
