...
<script type="text/javascript" src="modalfiles/modal.js"></script>
    ...
    <script type="text/javascript" src="scripts/jscF1_F2.js"></script>
...
<form name="frmF1_F2" >
    ...
    String strShowSeq="";
    String strResultsURL="frmF1_F2_Final_Results.jsp";
    ...
    if(StrNumberOfJudges.equals("3"))
        strResultsURL="frmF1_F2_Final_Results.jsp";
    else if(StrNumberOfJudges.equals("5"))
         strResultsURL="frmF1_F2_Final_Results_5.jsp";

  
      %>
    <table align="center" >
       <td><span ><font><h3><font color="blue"> <%=strEventOrder %> </font> <%=strEvnName %> <font color="blue"> <%=strEventDate %> </font> (<%=strShowName%>)  </h3></font></span></td>
       <td>   <input type="hidden" id="EventSeq" Name="EventSeq" value="<%=strEventSeq%>">
        </td>
     </table>
    ...
    if(StrNumberOfJudges.equals("3")) {%>
     ...
     <%@ include file="frmF1_F2_Include.jsp" %>
