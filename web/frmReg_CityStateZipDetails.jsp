...
function retnCSZCDetails(strCity,strState,strZip,strCountry)
{
    ...
    else if(parent.opener.document.forms[0].name=="frmReg_BreederAddPopup")
    { 
    parent.opener.document.getElementById("CITY").value=strCity;
    parent.opener.document.getElementById("STATE").value=strState;
    parent.opener.document.getElementById("ZIP").value=strZip;
    ...
    else if(parent.opener.document.forms[0].name=="Person_frm")
    {
    parent.opener.document.getElementById("CITY").value=strCity;
    parent.opener.document.getElementById("STATE").value=strState;
    parent.opener.document.getElementById("ZIP").value=strZip;
    ...
    else if(parent.opener.document.forms[0].name=="Pop_NewOwner")
    {
    parent.opener.document.getElementById("CITY").value=strCity;
    parent.opener.document.getElementById("STATE").value=strState;
    parent.opener.document.getElementById("ZIP").value=strZip;
    ...
    else if(parent.opener.document.forms[0].name=="frmMember")
    {
    parent.opener.document.getElementById("CITY").value=strCity;
    parent.opener.document.getElementById("STATE").value=strState;
    parent.opener.document.getElementById("ZIP").value=strZip;
...
<script type="text/javascript" src="modalfiles/modal.js"></script>
 <script type="text/javascript" src="scripts/SRegistraion.js"></script>
   ...
   CachedRowSet crsDetails= factory.createCachedRowSet();
...
<table class="grid" width="100%" style="border-color:Black;border-width:0px;border-style:None;width:100%;border-collapse:collapse;">
  ...
  <%
            ...
            <td height="22px"><input type="radio" Name="chkRadio" onClick="retnCSZCDetails('<%=strcity%>','<%=strState%>','<%=strZip%>','<%=strCountry%>')"></td>
            <td height="22px"><%=strcity%></td>
            <td height="22px"><%=strState%></td>
            <td height="22px"><%=strZip%></td>
            <td height="22px"><%=strCountry%></td>
            </tr>
