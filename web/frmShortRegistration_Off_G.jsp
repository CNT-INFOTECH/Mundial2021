...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <td width="17%" colspan="2">
      ...
      <input type="hidden" name="GroupSeq_S" id="GroupSeq_S"  value="<%=strSht_GroupSeq%>" >
      <input type="text"  style="background-color:  #FFF8DC; border:  1px solid #000000;"
               name="RegNum_S" id="RegNum_S" size="10" onChange="CheckRegNumExists1(RegNum_S,'<%=strEventSeq%>','Mare1')"
               value="<%=strSht_RegNum%>">
    <img alt="" src="Images/Find.gif" onClick="SearchHorse('PopHrs',600,600,'yes','1','2','<%=strEventSeq%>')"/>
    </td>
    ...
    <td width="20%" colspan="4">
      ...
      <a href="#" onClick="OpenLink('PopRegNum',600,600,'yes','frmHrsRegistration.jsp',RegSeq_S.value,'RegNum','Num=1')" >
          <font size="4" color="blue"><span  class="Onlycaps" ><%=strSht_HorseName%></span></font>
      </a>
    </td>
  ...
  <tr>
    ...
    <td width="15%" colspan="2"><font color="blue" size="2"><span class="Onlycaps"><%=strSht_Modality.trim()%></span></font>
  ...
  <tr>
    ...
    <td width="15%" colspan="4">
      ...
      <input type="text" name="Breeder_Assigned"  size="10" class="allcaps" id="Breeder_Assigned"
                    value="<%=strSht_BreederAssignedNum%>"
                    onBlur="GetPersonByAssignedNum_Grp(this.value,'BreederSeq','Breeder_Assigned','Breeder_Label')">
    ...
    <td width="15%" colspan="5">
      ...
      <img alt="" src="Images/Find.gif" onClick="SearchOwner('Owner',600,600,'yes','3','1')" >
