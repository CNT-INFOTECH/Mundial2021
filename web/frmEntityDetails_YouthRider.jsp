...
<script type="text/javascript" src="modalfiles/modal.js"></script>
 ...
 function fnHrsRegCount(evntSeq,RegNum){
    var CheckVal=trimRegister(RegNum)
    if(CheckVal=='')
        return false;
   
    var result=commonAjaxFn("","","Ajax_Common.jsp?Key=EventHrsRegCheck&param1="+CheckVal+"&param2="+evntSeq);      
    if(result!='Success'){
        fnCommonAlert_New(result,"","","Warning");  
        return false;
    }
	}
 </script>
 ...
 <table width="100%"border="0" cellspacing="1" cellpadding="2" >
    ...
    <td width="78"><font class="label">DOB</font></td>
      ...
      <td ><font >SCHOOL</font>
       <img alt="" src="Images/dropdown_icon4.gif"
                            onClick="OpenCommonRef('School','School','School_Lbl')"/>
      <td colspan="2">
          <font color="blue"><span id="School_Lbl" class="Onlycaps"></span></font>
        <input type="hidden"   class="allcaps"
            name="color" id="School" size="10"   value="">
    ...
    <td width="96"><font class="label">HREG#</font></td>
      <td colspan="9">
        ...
        <input type="text" name="Reg_Num"  size="10" class="allcaps"  id="Reg_Num" 
                    value="<%=strRegistration_Num%>"  onblur="GetHorseName_ByNum(this.value, 'RegSeq','Reg_Num','Name_Label','<%=strEventSeq%>'),fnHrsRegCount('<%=strEventSeq%>',this.value)">
    ...
    <tr>
      <td colspan="7" align="center">
        ...
        <input type="button" id="Reset" class="button" value="Reset" onclick="YouthRider_Reset('<%=strEventSeq%>','<%=strEvnName%>')"/>
       

        <input type="hidden" value="PERSON_EVENT" name="PageID"/>
