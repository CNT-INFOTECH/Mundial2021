        ...
        <tr>
          ...
          <td width="100" nowrap >
           <input type="hidden" id="RefSeq" name="RefSeq" value="<%=strFldSeq%>" >
            <input type="text" id="Desc"  name="Desc" value="<%=strFldVal%>" onKeyUp="javascript:this.value=this.value.toUpperCase()"  style="background-color:  #FFF8DC; border:  1px solid #000000;">
          </td>
        </tr>
        <tr>
