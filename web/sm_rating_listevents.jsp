...
{
	window.location.href="sm_rating_final_report.jsp?"+session+"&show="+Show+session+"&event="+Event+"_"+session;
}
...
//		Map obj=new LinkedHashMap();
        ...
        {%>
			 ...
			 <td class="contact" onClick="Navigate( <%=strShow%>,<%=rs1.getString("Event_Seq") %>,'<%=strSessionID%>') " >View Report
