...
<html>
  ...
  function returntoMain(SelValue)
  {
...
varDate=document.forms[0].fromDate.value


document.forms[0].method="post";
document.forms[0].action="ModalPop_Show.jsp?mode=1&SN="+showName+"&PL="+place+"&Dt="+varDate
...
<table class="altRow" width="100%">
  <tr>
    ...
    <td width="102"  >
      <input class="button" type="button" name="Search" value="Search" onClick="ShowList()">
    </td>
  </tr>
    ...
    <%@ include file="ModalPop_ShowList.jsp"%>
