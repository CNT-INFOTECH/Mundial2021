<%-- 
    Document   : FccrJudgesCard
    Created on : Feb 19, 2018, 1:27:02 PM
    Author     : Maheswari
--%>
	   ...
	   //To Fetch Judges Name
			try {
				...
				if (strCurrentClass != null && strCurrentClass.length() > 0) {
						...
						cst = null;
						cst = conn.prepareCall("{call [OnlineGet_Event_JudgeNames](?)}");
			...
			rs = null;
			cst = null;
		cst = conn.prepareCall("{call [OnlineGET_EVENT_PARTICIPANTS_F1F2_Mobile](?)}");
            cst.setString(1,strCurrentClass);
