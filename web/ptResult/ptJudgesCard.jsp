<%-- 
    Document   : ptJudgesCard
    Created on : Feb 22, 2018, 1:26:22 PM
    Author     : Maheswari
--%>
...
//			rs = null;
//			cst = null;
		cst = conn.prepareCall("{call OnlineGet_Event_JudgesMobile(?,?)}");
            cst.setString(1,strCurrentClass);
...
//        rs=cst.executeQuery();    
        while (rs.next()) {
			...
			|| rs.getString("Placement").equalsIgnoreCase("999"))
