<%-- 
    Document   : ptClasses
    Created on : Feb 21, 2018, 12:13:40 PM
    Author     : Maheswari
--%>
...
<%
    ...
    try {
		...
		cst = conn.prepareCall("{call OnlineGet_EventInformationMobile(?,?,?)}");
...
rs = cst.executeQuery();
        ...
        while (rs.next()) {
            ...
            obj.put("name", "CAT#"+ rs.getString("ConfepasoCategory")+" - "+rs.getString("name"));
			...
			obj.put("ConfepasoCategory", rs.getString("ConfepasoCategory"));
