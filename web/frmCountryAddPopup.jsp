<%-- 
    Document   : frmCountryAddPopup
    Created on : May 3, 2011, 12:41:27 PM
    Author     : Erzath
--%>
...
<%@ page import="pasotracker.GeneralServlet" %>  
    <body>
        <form name="CountryAddPopup" method="post">
<%
    String SeqNo="";
    String strValue="";
 ...
 RowSetFactory factory2crs1 = RowSetProvider.newFactory();
   CachedRowSet crs= factory2crs1.createCachedRowSet();
        ...
        <div id="wrapper1">
            <table width="100%" border="0" class="altRow">
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" maxlength="20" name="txtCountry_add" value="<%=strValue%>" id="txtCountry_add" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
                        <button id="AddCountryBtn" >Add</button>
                    </td>
                </tr>
            </table>
            <input type="hidden" name="HdnCountrySeq" id="HdnCountrySeq" value="<%=SeqNo%>">
        </div>
        </form>           
    </body>
</html>
