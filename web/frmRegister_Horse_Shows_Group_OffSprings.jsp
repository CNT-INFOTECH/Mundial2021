...
<%@ page import = "java.text.*" %>
    ...
    <body>
        ...
        <input type="hidden" id="EventName" Name="EventName" value="<%=strEventName%>">
         <input type="hidden" id="GroupSeq_S" Name="GroupSeq_S" value="<%=strGroupSeq%>">
        </td>
         </table>
        <table  width="100%" >
             <tr>
        ...
        <input type="text" name="Owner_Assigned_Main"  size="10" class="allcaps"  id="Owner_Assigned_Main"
                   value="<%=Owner_Assigned_Main%>"  onBlur="GetPersonByAssignedNum_Grp(this.value,'OwnerSeq_Main','Owner_Assigned_Main','owner_Label_Main')">
        ...
        <tr>
            <td>
                <div id="Mare1" >
                    <jsp:include page="frmShortRegistration_Off.jsp" >
        ...
        <tr><td>
                <div id="Mare2" >
                    <jsp:include page="frmShortRegistration_Off2.jsp"  >
                        <jsp:param name="mode" value="<%=strMode%>"></jsp:param>
...
<table  width="100%" align="center">
 ...
 <table width="30%" align="right">
    ...
    <input class="button" type="button" name="Save" value="Save" onClick="SRSubmit()">
     <input class="button" type="button" name="Rest" value="Reset" onClick="SRReset_Off(EventSeq,EventName)">
      <input class="button" type="button" name="Close" value="Close" onClick="JQueryClose_Short()">
      <input type="hidden" name="PageID" value="SPECIAL_EVENTS"/>
    </td>
