...
<table style="border-collapse:collapse;">
    ...
    </tr><% if(Shw_ScrnRegShwStatus_Ins.equals("Y") || Shw_ScrnRegShwStatus_View.equals("Y"))  {%> 
    <tr>
        <td>
    ...
    </tr><%}if(Shw_ScrnPlacementStatus_Ins.equals("Y") || Shw_ScrnPlacementStatus_View.equals("Y"))  {%> 						
    ...
    </tr><% }if(Shw_ScrnPtsTblStatus_Ins.equals("Y") || Shw_ScrnPtsTblStatus_View.equals("Y"))  {%> 
    ...
    </tr><%}if(Shw_ScrnDeviationStatus_Ins.equals("Y") || Shw_ScrnDeviationStatus_View.equals("Y"))  {%>
    ...
    <tr>
        ...
        border-left:  1px solid #5D92B1;
        border-right:  1px solid #5D92B1;
        padding: 4px;" >&nbsp;User Profile&nbsp;&nbsp&raquo;</div>
        </td>
    </tr>
