...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <td width="17%" colspan="2">
      ...
      <input type="text"  style="background-color:  #FFF8DC; border:  1px solid #000000;"
               name="RegNum_S2" id="RegNum_S2" size="10" onChange="CheckRegNumExists2(RegNum_S2,'<%=strEventSeq2%>','Mare2')"
               value="<%=strSht_RegNum2%>">
     <img alt="" src="Images/Find.gif" onClick="SearchHorse('PopHrs',600,600,'yes',2,'1','<%=strEventSeq2%>')"/>
    </td>
    ...
    <td width="20%" colspan="4">
      ...
      <font size="3" color="blue"><span  class="Onlycaps"><%=strSht_HorseName2%></span></font>
      </a>
    </td>
  ...
  <tr>
    ...
    <td colspan="4">
      ...
      <a href="#" onClick="OpenLink('PopDam',600,600,'yes','frmSHrsRegistration.jsp',dam2.value,'RegNum')">
  ...
  <tr>
    ...
    <td colspan="5">
      ...
      <img alt="" src="Images/Find.gif" onClick="SearchOwner('Owner',600,550,'yes','3','22')" >
  ...
  <tr>
      <td width="9%" nowrap><font class="label" size="3" color="red">OFF-SPRING</font>
      <input type="hidden" name="RegSeq_S_Off2" id="RegSeq_S_Off2"  value="<%=strSht_RegSeq_Off2%>">
    </td>
    <td colspan="7">
      <input type="text"  style="background-color:  #FFF8DC; border:  1px solid #000000;"
               name="RegNum_S_Off2" id="RegNum_S_Off2" size="10"
               onblur="GetHorseName_ByNum_off(this.value, 'RegSeq_S_Off2','RegNum_S_Off2','Name_Label_off2')"
               value="<%=strSht_RegNum_Off2%>" >
      <img alt="" src="Images/Find.gif" onClick="SearchHorse('PopHrs',600,600,'yes','1','12','')"/>
      <a href="#" onClick="OpenLink('PopRegNum',600,600,'yes','frmHrsRegistration.jsp',RegSeq_S_Off2.value,'RegNum','Num=2')" >
      <span id="Name_Label_off2" style="color :blue; font-size:12px"  class="Onlycaps"><%=strSht_HorseName_Off2%></span></a>
      <input type="hidden"  name="HorseName_S_Off2" size="40" class="allcaps"
        value="<%=strSht_HorseName_Off2%>">
    </td>
  </tr>
</table>
<br>
