...
<%@ page import="pasotracker.ReferenceValueServlet" %>  

    <body>
        <form name="ColorAddPopup" method="post">
<%
    String SeqNo="";
    String strValue="";
 ...
 RowSetFactory factory2ct = RowSetProvider.newFactory();
   CachedRowSet crs= factory2ct.createCachedRowSet();
        ...
        <div id="wrapper1">
            <table width="100%" border="0" class="altRow">
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" maxlength="20" name="txtColor_add" onKeyUp="javascript:this.value=this.value.toUpperCase()"   value="<%=strValue%>" id="txtColor_add" />
                    </td>
                </tr>
                <tr>
             ...
             <input type="hidden" name="HdnColorSeq" id="HdnColorSeq" value="<%=SeqNo%>">
        </div>
        </form>           
    </body>
</html>
