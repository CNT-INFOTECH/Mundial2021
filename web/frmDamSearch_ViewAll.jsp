<%--
    Document   : frmDamSearch_ViewAll
    Created on : Jun 22, 2011, 1:11:41 PM
    Author     : veera
--%>
...
<%
 ...
 RowSetFactory factory98 = RowSetProvider.newFactory();
   CachedRowSet crsGetHorseDetails= factory98.createCachedRowSet();
