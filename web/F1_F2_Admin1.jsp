...
<div id="container">
    ...
    %>
        ...
        <div id="content">
            ...
            <td width=100">
            <input size="100px" id='Shows' name="Shows"  value="<%=strShowName_Head%>" style=" background:  #FFF8DC url(Images/magnifier.png) no-repeat 1px 1px; border: 1px solid #000000;
            height: 16px;
            padding-left: 18px;
