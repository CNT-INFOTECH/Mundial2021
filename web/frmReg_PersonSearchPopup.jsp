...
function SearchPersonInformation(objType)
{
    if(opener.document.forms[0].name=="Person_frm")
    {
    document.forms[0].method="post";
    document.forms[0].action="frmReg_PersonSearchPopup.jsp?srch=1&typ=5"
    ...
    {
    document.forms[0].method="post";
    document.forms[0].action="frmReg_PersonSearchPopup.jsp?srch=1&typ=1&tpe="+objType;
    document.forms[0].submit();
    }
}
...
function ViewAll_Owner(strName){
    ...
    {
    document.forms[0].method="post";
    document.forms[0].action="frmReg_PersonSearchPopup.jsp?srch=1&typ=2"
    ...
    {
    document.forms[0].method="post";
    document.forms[0].action="frmReg_PersonSearchPopup.jsp?srch=1&typ=6"
    document.forms[0].target="_self";
    document.forms[0].submit();
    }
    ...
    {
    document.forms[0].method="post";
    document.forms[0].action="frmReg_PersonSearchPopup.jsp?srch=1&typ=4"
    document.forms[0].target="_self";
    document.forms[0].submit();
    }
}
...
function Reset_Per(Name,No,phone)
{
    document.getElementById(Name).value='';
    document.getElementById(No).value='';
    ...
    document.forms[0].method="post";
    document.forms[0].action="frmReg_PersonSearchPopup.jsp"
    document.forms[0].target="_self";
    document.forms[0].submit();
...
<form name="Reg_NewPersonInformationSearch" >
    ...
    <table class="altRow">
		...
		-->
            ...
            <td  colspan="6" align="right">
                <input type="button" value="Search" class="button" onclick="SearchPersonInformation('<%=srchType%>')"/>
                <input type="button" value="Reset" class="button" onclick="Reset_Per('Owner_No','Org_Name','Phone')"/>
